...
public class CurrentPlanWorkoutsListAdapter extends RecyclerView.Adapter<CurrentPlanWorkoutsListAdapter.ViewHolder> {
    ...
    public CurrentPlanWorkoutsListAdapter(Context context, List<Workout> workoutsList, int currentDay){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            next = itemView.findViewById(R.id.workout_next);
